...
def generate_dataset(numData, stringLength, hashType):
    ...
    for i in range(numData):
        ...
        newString = ''.join(random.SystemRandom().choice(string.ascii_lowercase 
        + string.ascii_uppercase + string.digits) for _ in range(stringLength))
